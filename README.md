...
[![PhotoPicker](https://img.shields.io/badge/PhotoPicker-1.0.33-brightgreen.svg?style=plastic)](http://walkermanx.github.io)
...
**2.** 在你的项目module的`build.gradle `文件中引入依赖：
   ...
   ```groovy
    ...
    implementation 'com.github.walkermanx:PhotoPicker:1.0.33'
