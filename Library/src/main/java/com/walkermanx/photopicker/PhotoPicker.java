...
public class PhotoPicker {
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setToolbarTitleMarginStart(@DimenRes int titleMarginStart) {
            mPickerOptionsBundle.putInt(EXTRA_TITLE_MARGIN_START, titleMarginStart);
            return this;
        }
    }
}
